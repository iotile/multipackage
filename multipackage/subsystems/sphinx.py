...
class SphinxDocumentation(object):
    ...
    This subsystem will build html documentation using the read_the_docs theme
    in the folder ``built_docs``.  It expects source documentation to exist in
    the folder ``docs`` that is augmented automatically with release notes for
    each project in the repository and template-based API documentation for
    each python package in the repository.
